...
st.write("## Project Summary")	st.write("## Project Summary")


st.info(	st.info(
    f"Test1"	    f"**Background information:**\n\n"
...
st.write(	st.write(
    f"Test2"	    f"For any additional information, please visit and\n"
    f"**read**:\n"
...
st.success(	st.success(
    f"Test3"	    f"The project contains 2 **Business Requirements**:\n"
...
st.sidebar.write("Select page above to view")	st.sidebar.write("Select page above to view")